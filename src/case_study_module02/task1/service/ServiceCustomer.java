...
import case_study_module02.task1.repository.IRepositoryCustomer;
...
public class ServiceCustomer implements IServiceCustomer{
    ...
    public void addCustomer() {
        try{
            ...
            System.out.println("thêm email cho Customer Vui Lòng phải nhập đúng định dạng sau (nguyenvana@gmail.com)");
    ...
    public void fixCustomer() {
        System.out.println("mời bạn nhập mã code của Customer cần sửa vào đây");
