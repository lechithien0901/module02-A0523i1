...
import case_study_module02.task1.repository.FacilityRepository;
import case_study_module02.task1.repository.IRepositoryBooking;
import case_study_module02.task1.repository.RepositoryBooking;
import case_study_module02.task1.repository.RepositoryCustomer;
    ...
    public void addBooking() {
        ...
        while (!checkInput) {
            try {
                ...
                LocalDate dateOfRent = LocalDate.of(Integer.parseInt(stringSplit[0]), Integer.parseInt(stringSplit[1]), Integer.parseInt(stringSplit[2]));
                ...
                LocalDate dateStar = LocalDate.of(Integer.parseInt(stringSplitStarDate[0]), Integer.parseInt(stringSplitStarDate[1]), Integer.parseInt(stringSplitStarDate[2]));
                ...
                LocalDate dateEnd= LocalDate.of(Integer.parseInt(stringSplitEndDate[0]), Integer.parseInt(stringSplitEndDate[1]), Integer.parseInt(stringSplitEndDate[2]));
