...
public class RepositoryCustomer implements IRepositoryCustomer {
    ...
    static {
        ...
        customerArrayList.add(new Customer("KH-0003", "Nguyen Van C", "2001-03-03", "Nam", "000000003", "0937275125", "nguyenvanc@gamil.com", "Gold", "Hoàng Diệu"));
    }

    static final String FILE_SOURCE = "C:\\Users\\ADMIN\\IdeaProjects\\module02\\src\\case_study_module02\\task1\\customer.csv";
        ...
        try {
           RepositoryCustomer repositoryCustomer = new RepositoryCustomer();
            ...
            for (int i = 0; i < arrayList.size(); i++) {
                if (arrayList.get(i).getCustomerCode().equals(nameNeedFix)) {
                    check = false;
                    int choiceOfMe;
                    do {
