...
import java.util.regex.Pattern;
    ...
    public class RepositoryEmployee implements IRepositoryEmployee {
        ...
        static final String FILE_SOURCE = "C:\\Users\\ADMIN\\IdeaProjects\\module02\\src\\case_study_module02\\task1\\employee";
             ...
             RepositoryEmployee repositoryEmployee=new RepositoryEmployee();
                ...
                while (!check){
                    ...
                    for (int i = 0; i <arrayList.size() ; i++) {
                        if (arrayList.get(i).getNameEmployee().equals(name)){
                ...
                System.out.println("đối tượng đã thêm thành công");
