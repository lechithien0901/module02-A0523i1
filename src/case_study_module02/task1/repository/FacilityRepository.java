...
import case_study_module02.task1.model.House;
import case_study_module02.task1.model.Room;
import case_study_module02.task1.model.Villa;
...
public class FacilityRepository implements IFacilityRepository{
    ...
    static {
        facilityIntegerLinkedHashMap.put(new Villa("SVVL-0000", "Villa", 40, 40, 11, "Năm", "Vip", 40, 7), 0);
        facilityIntegerLinkedHashMap.put(new Villa("SVVL-0001", "Villa", 40, 40, 11, "Năm", "Vip", 40, 7), 0);
        facilityIntegerLinkedHashMap.put(new Villa("SVVL-0002", "Villa", 40, 40, 11, "Năm", "Vip", 40, 7), 0);

    }

    public  LinkedHashMap<Facility, Integer> getFacilityIntegerLinkedHashMap() {
