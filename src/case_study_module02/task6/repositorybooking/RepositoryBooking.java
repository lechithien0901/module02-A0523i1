...
public class RepositoryBooking implements IRepositoryBooking {
    ...
    static {
        bookingTreeSet.add(new Booking("B0000", new Date(2023, 9, 5), new Date(2023, 9, 10), new Date(2023, 9, 15), "SVVl-0000", "KH-0000"));
        bookingTreeSet.add(new Booking("B0001", new Date(2023, 9, 5), new Date(2023, 9, 10), new Date(2023, 9, 11), "SVVl-0001", "KH-0001"));
        bookingTreeSet.add(new Booking("B0002", new Date(2023, 8, 5), new Date(2023, 8, 9), new Date(2023, 8, 11), "SVVl-0002", "KH-0002"));
    }
